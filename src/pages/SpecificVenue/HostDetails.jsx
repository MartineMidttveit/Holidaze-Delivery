    ...
    <>
      {!isOwner && (
        <div className="flex justify-between items-center xl:mt-2 2xl:mt-0 border-b border-t xl:border-t-0 py-6 border-secondary xl:border-b-0 xl:py-0">
          ...
          <button disabled type='button' className='text-sm 2xl:text-base rounded px-3 lg:px-8 border border-secondary h-12 2xl:h-14 hover:bg-contrast duration-300 hover:text-white hover:border-contrast flex items-center justify-center'>
            Message
